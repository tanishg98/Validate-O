...
os.chdir('/Users/tanishgirotra/validate-o-sever/routes/VALIDATE_O/hospital')
os.chdir('/Users/tanishgirotra/validate-o-sever/routes/VALIDATE_O/hospital/data') 
os.chdir('/Users/tanishgirotra/validate-o-sever/routes/VALIDATE_O/hospital/data/image') 

urllib.request.urlretrieve("https://i.pinimg.com/236x/4f/d8/6a/4fd86aa61239d692354ac95e8804b05f.jpg", "local-filename.jpg")
#os.chdir(prevdir)
os.chdir('/Users/tanishgirotra/validate-o-sever/routes/VALIDATE_O/hospital/data2/image2')
...
train_data_dir = '/Users/tanishgirotra/validate-o-sever/routes/VALIDATE_O/hospital/data'
nb_train_samples = 1
epochs = 3
batch_size = 1
...
top_model_weights_path = 'bottleneck_fc_model.h5'
train_data_dir = '/Users/tanishgirotra/validate-o-sever/routes/VALIDATE_O/hospital/data2'
nb_train_samples = 1
epochs = 3
batch_size = 1
